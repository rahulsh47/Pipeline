...
//        WebElement VisitTheCart = driver.findElement(By.xpath("//span[@class='counter-number']"));
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
//        VisitTheCart.click();
//
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
...
//        WebElement NextButtonClick = driver.findElement(By.cssSelector("//span[normalize-space()='Next']"));
//        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
